            ...
            pytest.param(
                {
                    ...
                    "expected_code": "ef000101000802000100030400ff0000800001000000003050000bad60A7",  # noqa: E501
                    "expected_exception": [
            ...
            pytest.param(
                {
                    ...
                    "expected_code": "ef000101000802000100030400ff0000800001000000003050003050000bad60A7",  # noqa: E501
                    "expected_exception": [
                        EOFException.INVALID_TYPE_SECTION_SIZE,
                        EOFException.INVALID_SECTION_BODIES_SIZE,
                    ],
            ...
            pytest.param(
                {
                    ...
                    "skip_body_listing": True,
                    "expected_code": "ef0001010008020002000300030400ff0000800001000000003050000bad60A7",  # noqa: E501
                    "expected_exception": [
            ...
            pytest.param(
                {
                    "skip_header_listing": False,
                    "skip_body_listing": False,
                    "expected_code": "ef0001010008020002000300030400ff0000800001000000003050003050000bad60A7",  # noqa: E501
            ...
            pytest.param(
                {
                    ...
                    "expected_code": "ef000101000802000100030400ff00008000013050000bad60a7",
                    "expected_exception": [
                        EOFException.INVALID_TYPE_SECTION_SIZE,
                        EOFException.INVALID_SECTION_BODIES_SIZE,
                    ],
            ...
            pytest.param(
                {
                    ...
                    "expected_code": "ef000101000402000100030400ff00008000013050000bad60a7",
                    "expected_exception": None,
                },
                id="drop_everything",
            ),
